...
const output = {
  ...
  evidence: 'evidence:20260527-bonsai-diagnosis-model-evaluation',
  summary,
  results,
  notes: [
    'This is real Bonsai 1.7B Q1_0 through loopback llama.cpp, not fake-provider proof.',
...
writeFileSync(join(outDir, 'real-bonsai-eval-results.json'), `${JSON.stringify(output, null, 2)}\n`);
writeFileSync(join(outDir, 'real-bonsai-eval-summary.json'), `${JSON.stringify(summary, null, 2)}\n`);
